...
class HumanParsingDatasetWithPoseWithClassifcation(torch.utils.data.Dataset):
...
if __name__ == "__main__":
    ...
    dataset = HumanParsingDatasetWithPoseWtihClassifcation(
        dataset_path=dataset_path, train_mode=True
    )
    for i in range(len(dataset) - 1):
        ...
        print(output["label_classification"].size())
        break
